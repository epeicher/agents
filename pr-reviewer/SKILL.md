---
name: pr-reviewer
description: Reviews pull requests for WordPress Studio (Electron desktop app, React + TypeScript, WordPress Playground). Use this skill whenever the user asks to review a PR, review changes, review a diff, or asks for feedback on code changes in the Studio repo — even if they don't say "review" explicitly (e.g. "what do you think of this PR", "any issues with these changes", "look at PR #123").
---

# WordPress Studio PR Reviewer
...
12. **React & Performance**
    ...
    - Memory leaks: verify event listeners are cleaned up on unmount
